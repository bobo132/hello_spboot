package com.bobo.hello_spboot.config.mq;
...
public class RabbitMqConfig {
    ...
    /**
     * Exchange: 交换器, 接受消息, 按照路由规则将消息路由到一个或者多个队列.
     * Binding: 绑定, 交换器和消息队列之间的虚拟连接, 绑定中可以包含一个或多个 RoutingKey.
     * RoutingKey: 路由键, 生产者将消息发送给交换器的时候, 会发送一个 RoutingKey, 用来指定路由规则, 这样交换器就知道把消息发送到哪个队列.
     */
